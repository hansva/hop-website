...
|{set:cellbgcolor:#30328422}Enterprise- und Geo-Datenintegration mit Apache Hop|Vernetze dich mit der Community rund um Apache Hop – der leistungsstarken Open-Source-Plattform für ETL. Wir zeigen den Stand aktueller GIS-Plugins. Beteilige dich an der Diskussion, bringe deine Anwendungsfälle ein und gestalte die Priorisierung neuer Features.|2026-03-27|DE|https://pretalx.com/fossgis2026/talk/B379DJ/[Register^]|
...
|Webinar Möglichkeiten der Enterprise- und Geo-Datenintegration
